...
public class Universe extends World{
  ...
  */
    ...
    void moveObjects() {
        ...
        //checks to see if the frog has died and if so kills frog
        this.dead();
        
        //checks to see if the frog is on a lilly or a log and moves 
        //him accordingly
        this.moveOnLilog();
        
        //checks to see if the forg has reached the last lane. 
        //If he has than the score increases and the frog is
        //sent to the beginning
        this.win();

        //for all the lanes in the game...
        for (ALane l : this.lanes) {
            //shift the objects in this lane right or left
            l.shift();
            
            //create new objects on the appropriate side of the screen 
            l.spawn();
            
            //deletes old objects that have left the screen
            l.delete();
